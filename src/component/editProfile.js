            ...
            <View style={styles.container}>
                <ImageBackground source={require('./../image/background.png')} style={{ width: '100%', height: '100%' }} resizeMode='stretch'>
                    <ScrollView>
                        ...
                        <View style={{ alignItems: 'center', marginTop: HEIGHT / 35, marginBottom: 50 }}>
                            <Text style={{ color: 'white', fontSize: 40, textAlign: 'center' }}>E d i t  P r o f i l e</Text>
                        </View>
                        ...
                        <View style={{ paddingLeft: 20 }}>
                            <Text style={{ color: 'white', fontSize: 35, textAlign: 'left', marginTop: 30, }}>Two truths and a lie</Text>
                            <View>
                                <Text style={{ color: '#ffffff', fontSize: 25, marginLeft: 20, marginBottom: 10, marginTop: 20 }}>Truth</Text>
                                ...
                                <Text style={{ color: '#ffffff', fontSize: 25, marginLeft: 20, marginTop: 20, marginBottom: 10 }}>Truth</Text>
                                <View style={styles.firstInput}>
                                    <TextInput
                                        style={styles.input}
                                        placeholderTextColor={'#98b4db'}
                                ...
                                <Text style={{ color: '#ffffff', fontSize: 25, marginLeft: 20, marginTop: 20, marginBottom: 10 }}>Lie</Text>
                                <View style={styles.firstInput}>
                                    <TextInput
                                        style={styles.input}
                                        placeholderTextColor={'#98b4db'}
